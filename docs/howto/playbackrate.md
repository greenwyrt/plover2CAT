...
Plover2CAT has **Speed Up** and **Slow Down** under the **Media** menu. These buttons will increment the playback rate up/down. The benefit is that these menu items have shortcuts so it is possible to assign outlines to control the playback rate without needing to move away from the keyboard.