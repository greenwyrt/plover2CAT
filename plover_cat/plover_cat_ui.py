...
# Form implementation generated from reading ui file '.\plover_cat.ui'
#
...
class Ui_PloverCAT(object):
    def setupUi(self, PloverCAT):
        ...
        self.dockAudio.setMinimumSize(QtCore.QSize(256, 89))
        ...
        self.styling_pane.setGeometry(QtCore.QRect(0, 0, 363, 472))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/edit-bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/edit-italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/edit-underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/edit-alignment.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/edit-alignment-center.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/edit-alignment-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/edit-alignment-justify-distribute.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/edit-style.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.styling_pane, icon7, "")
        self.page_format_pane = QtWidgets.QWidget()
        self.page_format_pane.setGeometry(QtCore.QRect(0, -272, 414, 415))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/document-resize-actual.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.page_format_pane, icon8, "")
        self.find_replace_pane = QtWidgets.QWidget()
        self.find_replace_pane.setGeometry(QtCore.QRect(0, -74, 300, 217))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/magnifier.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.find_replace_pane, icon9, "")
        self.paragraph_pane = QtWidgets.QWidget()
        self.paragraph_pane.setGeometry(QtCore.QRect(0, -89, 251, 215))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/edit-pilcrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.paragraph_pane, icon10, "")
        self.audio_recording_pane = QtWidgets.QWidget()
        self.audio_recording_pane.setGeometry(QtCore.QRect(0, -136, 239, 279))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/microphone.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.audio_recording_pane, icon11, "")
        self.spellcheck_pane = QtWidgets.QWidget()
        self.spellcheck_pane.setGeometry(QtCore.QRect(0, -21, 344, 164))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/spell-check.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.dockStenoData.setMinimumSize(QtCore.QSize(91, 113))
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/folder-open-document-text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/document.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew.setIcon(icon14)
        self.actionNew.setObjectName("actionNew")
        self.actionSave = QtWidgets.QAction(PloverCAT)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/disk-black.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/plus-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddCustomDict.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/scissors-blue.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCut.setIcon(icon17)
        self.actionCut.setObjectName("actionCut")
        self.actionCopy = QtWidgets.QAction(PloverCAT)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/clipboard--plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopy.setIcon(icon18)
        self.actionCopy.setObjectName("actionCopy")
        self.actionPaste = QtWidgets.QAction(PloverCAT)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/clipboard-paste-document-text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPaste.setIcon(icon19)
        self.actionPaste.setObjectName("actionPaste")
        self.actionZoomIn = QtWidgets.QAction(PloverCAT)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/magnifier-zoom-in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionZoomIn.setIcon(icon20)
        self.actionZoomIn.setObjectName("actionZoomIn")
        self.actionZoomOut = QtWidgets.QAction(PloverCAT)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/magnifier-zoom-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionZoomOut.setIcon(icon21)
        self.actionZoomOut.setObjectName("actionZoomOut")
        self.actionUndo = QtWidgets.QAction(PloverCAT)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/arrow-curve-180.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/arrow-curve.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/folder-open-document-music.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/control-skip-180.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/control-skip.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/control-stop-square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/control-stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/arrow-join.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/arrow-split.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/clipboard.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionFindReplacePane.setIcon(icon9)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/control-record.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/minus-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/lock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/book-question.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/card--plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRetroactiveDefine.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/arrow-stop-180.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDefineLast.setIcon(icon38)
        self.actionDefineLast.setObjectName("actionDefineLast")
        self.actionAbout = QtWidgets.QAction(PloverCAT)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/wand.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/control-cursor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/lightning.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menuEdit.addAction(self.actionFindReplacePane)
        ...
        self.toolbar_steno.addAction(self.actionAddCustomDict)
        self.toolbar_steno.addAction(self.actionMergeParagraphs)
        self.toolbar_steno.addAction(self.actionSplitParagraph)
        self.toolbar_steno.addAction(self.actionAddAutocompletionTerm)
        self.toolbar_steno.addAction(self.actionRetroactiveDefine)
        self.toolbar_steno.addAction(self.actionDefineLast)
        self.toolbar_audio.addAction(self.actionPlayPause)
        self.toolbar_audio.addAction(self.actionStopAudio)
        self.toolbar_audio.addAction(self.actionRecordPause)
        ...
        self.actionZoomIn.triggered.connect(self.textEdit.zoomIn) # type: ignore
        self.actionZoomOut.triggered.connect(self.textEdit.zoomOut) # type: ignore
        ...
        self.actionNormalCopy.triggered.connect(self.textEdit.copy) # type: ignore
...
"time from next paragraph."))
        ...
        self.actionZoomIn.setText(_translate("PloverCAT", "Zoom In"))
        self.actionZoomIn.setShortcut(_translate("PloverCAT", "Ctrl+="))
        self.actionZoomOut.setText(_translate("PloverCAT", "Zoom Out"))
        self.actionZoomOut.setShortcut(_translate("PloverCAT", "Ctrl+-"))
        ...
        self.actionMergeParagraphs.setToolTip(_translate("PloverCAT", "Merge two paragraphs by selecting across \n"
...
"paragraphs to merge"))
        ...
        self.actionFindReplacePane.setText(_translate("PloverCAT", "Find/Replace Pane"))
        ...
        self.actionCursorAtEnd.setToolTip(_translate("PloverCAT", "All writing will be appended to end of document"))
        self.actionCaptureAllOutput.setText(_translate("PloverCAT", "Capture All Steno Output"))
        self.actionCaptureAllOutput.setToolTip(_translate("PloverCAT", "Steno output will be recorded even if window is not in focus"))
        ...
        self.actionDefineLast.setText(_translate("PloverCAT", "Define Last"))
...
if __name__ == "__main__":
    ...
    PloverCAT = QtWidgets.QMainWindow()
    ui = Ui_PloverCAT()
    ui.setupUi(PloverCAT)
    PloverCAT.show()
    sys.exit(app.exec_())
