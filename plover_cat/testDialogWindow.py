...
class TestStenoData(unittest.TestCase):
    ...
    def test_index_element(self):
        indices = {
            "0": {
                "prefix": "Exhibit",
                "hidden": True,
                "entries": {"A": " A glass.", "B": " Two glasses."},
            },
            "1": {
                "prefix": "Index",
                "hidden": False,
                "entries": {"1": " The first.", "2": " The second."},
            },
        }
        index_name = "0"
        ...
        el = index_text(
            ...
            description=index_dict["entries"][entry_text],
            hidden=index_dict["hidden"],
            text=entry_text,
        )
    ...
    def test_element_collection(self):
        stroke_data = [
            text_element(text="ABC"),
            text_element(text="2 ", time="2000-01-23T00:00:00.111"),
            stroke_text(
                stroke="EUFS",
                text="I was ",
                time="2100-01-24T00:00:00.111",
                audiotime="00:00:01.123",
            ),
...
class TestTextEdit(unittest.TestCase):
    ...
    def step_SplitPar(self):
        ...
        save_json(
            one_text,
            self.editor.textEdit.file_name.joinpath(
                self.editor.textEdit.file_name.stem
            ).with_suffix(".transcript"),
        )
        self.editor.close_file()
    ...
    def step_InsertText(self):
        ...
        self.assertEqual(
            self.editor.textEdit.toPlainText(), "This is one line.\nThis is the second."
        )
        self.editor.textEdit.clear_transcript()
        self.editor.textEdit.insert_text(
            ["This is one line.", "This is the second.", "This is 3?"]
        )
        self.assertEqual(
...
class testDialogWindow(QDialog, Ui_testDialog):
    ...
    def __init__(self, editor):
        ...
        self.selection = {
            "step_ConfirmFiles": "Setup files are present",
